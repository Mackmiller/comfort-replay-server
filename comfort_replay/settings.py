"""
Django settings for comfort_replay project.
...
MIDDLEWARE = [
    ...
    # added whitenoise for deployment
...
ROOT_URLCONF = 'comfort_replay.urls'
...
WSGI_APPLICATION = 'comfort_replay.wsgi.application'
...
# forever-cacheable files and compression support from white noise
